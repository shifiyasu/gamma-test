...
mixin _$Series {
  ...
  int get numberOfEpisodesPerSeason => throw _privateConstructorUsedError;
...
class _$SeriesCopyWithImpl<$Res, $Val extends Series>
  ...
  $Res call({
    ...
    Object? numberOfEpisodesPerSeason = null,
  }) {
    return _then(_value.copyWith(
      ...
      numberOfSeasons: null == numberOfSeasons
          ...
          : numberOfSeasons // ignore: cast_nullable_to_non_nullable
              as int,
      numberOfEpisodesPerSeason: null == numberOfEpisodesPerSeason
          ? _value.numberOfEpisodesPerSeason
          : numberOfEpisodesPerSeason // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$SeriesImpl implements _Series {
  const _$SeriesImpl(
      ...
      required this.numberOfEpisodesPerSeason});
  ...
  @override
  final int numberOfEpisodesPerSeason;

  @override
  String toString() {
    return 'Series(id: $id, name: $name, imageUrl: $imageUrl, numberOfSeasons: $numberOfSeasons, numberOfEpisodesPerSeason: $numberOfEpisodesPerSeason)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.numberOfEpisodesPerSeason,
                    numberOfEpisodesPerSeason) ||
                other.numberOfEpisodesPerSeason == numberOfEpisodesPerSeason));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, imageUrl,
      numberOfSeasons, numberOfEpisodesPerSeason);
...
abstract class _Series implements Series {
  const factory _Series(
      ...
      required final int numberOfEpisodesPerSeason}) = _$SeriesImpl;
  ...
  @override
  int get numberOfEpisodesPerSeason;
  @override
  @JsonKey(ignore: true)
  _$$SeriesImplCopyWith<_$SeriesImpl> get copyWith =>
